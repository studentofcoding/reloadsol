...
import { withUnifiedLogging, log, logTradeOperation } from '@/utils/unified-logger'
import {
...
//   const strategyId = (simulation.buy_operation as any)?.bot_strategy || getCurrentBotStrategySync()
