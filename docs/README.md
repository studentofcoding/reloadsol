...
| — | [SPEC-potential-rug-labels-tracker-honesty-v1.md](./specs/SPEC-potential-rug-labels-tracker-honesty-v1.md) | To-spec: MCap auto-rule potential/rugged labels, OHLC corpus, Tracker tabs, token-map honesty. Not implemented yet |
