...
| Buy-bulk data-public scout | `/buy` observe strip | Local paper notes only (`buybulk-datapublic-scout`). **Not** rh-tape (`rhtape-datapublic-scout`) | [STRATEGY_SCOUT.md](./STRATEGY_SCOUT.md) — no shared config/store/routes |
